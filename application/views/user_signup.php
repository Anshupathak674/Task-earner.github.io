			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12" >
						...
						<form action="<?= base_url() ?>gen_otp" method="POST" >							
							...
							<input type="text" name="user_referal_code" class="form-control" placeholder="Referal Code (if any)">

							<div class="form-footer">
								<button style="margin: auto;" type="submit" class="btn btn-primary">Create Account</button>
								
								<a style="margin: auto;"  href="<?= base_url() ?>" class="" ><button type="button" class="btn btn-danger">Back</button></a>
							</div><!-- End .form-footer -->
						</form>
					</div><!-- End .col-md-6 -->
