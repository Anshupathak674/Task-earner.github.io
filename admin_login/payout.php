...
$beneficiary = array(
    'beneId' => $_POST['user_details_id'],
    'name' => $_POST['user_name'],
    'email' => $_POST['user_email'],
    'phone' => $_POST['user_number'],
    'bankAccount' => $_POST['user_bank'],
    'ifsc' => $_POST['user_ifsc'], 
    'address1' => $_POST['user_address'],
...
$transfer = array(
    'beneId' => $_POST['user_details_id'],
    'amount' => $_POST['req_wallet_amount'],
    'transferId' => $_POST['payments_history_id'],
);
...
header('Location: http://localhost/higroove/ankit/admin_login/tasker_do_payment?all_bids_id='.$_POST['payments_history_id']);
die();
