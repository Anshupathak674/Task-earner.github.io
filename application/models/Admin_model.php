...
class Admin_model extends CI_Model
{
  ...
  //...........add to cart.................//
  function add_to_cart($project_ss)
  {
    $user_details_id = $this->session->userdata('user_details_id');
  ...
  function payment_req()
  {
    $user_details_id = $this->session->userdata('user_details_id');
    $user_wallet_amount = $this->session->userdata('user_wallet_amount');
    date_default_timezone_set("Asia/Kolkata");
    $date=date('Y-m-d h:i:sa ');
    extract($this->input->post());
    ...
    $formArray = array(
      'user_details_id'  => $user_details_id,
      'req_wallet_amount'  => $user_wallet_amount,
      'req_date'  => $date,
    ...
    $this->db->insert('payments_history', $formArray);
    ...
    $this->session->set_userdata('user_wallet_amount', 0);
  }
