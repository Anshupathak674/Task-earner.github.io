					...
					if ($all_bids) {
						...
						foreach ($all_bids as $bids) {
							...
							<div class="product-action">
								...
								<input type="hidden" name="bid_price" value="<?= $view_advertisement['product_offer_price'] ?>">
									<input style="color:#222529" class=" form-control" value="<?= $view_advertisement['product_offer_price'] ?>" required name="bid_price" type="hidden">
								...
								<div class="form-group required-field">
									<label>ScreenShot of your Task </label>
									<div class="form-control-tooltip">
									<input style="color:#222529" class=" form-control" value="7" name="project_ss" required type="file">
								...
								<button type="submit" class="btn btn-dark add-cart " title="Place Bid">Submit Task</button>
