...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2021 at 06:20 PM
...
CREATE TABLE `all_bids` (
  ...
  `project_ss` varchar(255) NOT NULL,
...
INSERT INTO `all_bids` (`all_bids_id`, `tasker_details_id`, `add_id`, `user_details_id`, `bid_status`, `bid_date`, `proposal_description`, `payment_date`, `project_ss`, `bid_price`) VALUES
(2, 1, 18, 1, 4, '2021-02-20 11:59:06', 'hihihii', '2021-03-12 02:46:06', '', 0),
(7, 1, 19, 1, 2, '2021-02-20 03:22:45', 'this is proposal', '0000-00-00 00:00:00', '', 0),
(10, 1, 18, 12, 4, '2021-04-09 10:36:31', 'ffs', '0000-00-00 00:00:00', 'rohan2.jpg', 0);
...
CREATE TABLE `payments_history` (
  `payments_history_id` int(11) NOT NULL,
  `user_details_id` int(11) NOT NULL,
  `req_wallet_amount` int(11) NOT NULL,
  `req_date` datetime NOT NULL,
  `payment_status` int(11) NOT NULL,
  `payment_date` datetime NOT NULL,
  `user_number` bigint(20) NOT NULL,
  `user_bank` varchar(255) NOT NULL,
  `user_ifsc` varchar(255) NOT NULL,
...
INSERT INTO `payments_history` (`payments_history_id`, `user_details_id`, `req_wallet_amount`, `req_date`, `payment_status`, `payment_date`, `user_number`, `user_bank`, `user_ifsc`, `user_city`, `user_state`, `user_pincode`, `user_address`) VALUES
(14, 12, 1522, '2021-04-10 10:25:34', 1, '2021-04-10 06:07:33', 0, '', '', '', '', 0, ''),
(17, 12, 2332, '2021-04-12 09:09:29', 0, '0000-00-00 00:00:00', 0, '', '', '', '', 0, ''),
(21, 12, 410, '2021-04-12 09:08:08', 1, '2021-04-12 10:54:39', 9213102971, '000890289871772', 'SCBL0036078', 'sfe', 'sfds', 2223, 'fsdf');
...
CREATE TABLE `tasker_details` (
  ...
  `min_wid_amount` int(11) NOT NULL,
...
INSERT INTO `tasker_details` (`tasker_details_id`, `tasker_name`, `tasker_email`, `tasker_password`, `tasker_date`, `tasker_profile_pic`, `tasker_address`, `tasker_mobile`, `min_wid_amount`, `payouts`) VALUES
(1, 'admin', 'admin@gmail.com', '123', '2021-02-20 12:31:12', 'rohan23.jpg', 'RZ-G-149,Sita Puri--II, GALI NO 5, NEW DELHI 45', 0, 400, 1932);
...
CREATE TABLE `user_details` (
  ...
  `user_referal_code` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user_details` (`user_details_id`, `user_name`, `user_email`, `user_password`, `user_wallet_amount`, `user_date`, `user_profile_pic`, `user_referal_code`) VALUES
(1, 'admin', 'admin@gmail.com', '123456', 410, '2020-11-27', 'rohan24.jpg', '11111111'),
(12, 'rajesh', 'sharmarajesh1077@gmail.com', '123456', 444, '2021-04-09', '', '11111111'),
(14, 'Admin', 'admin11@gmail.com', '123456', 0, '2021-04-13', '', 'D3pEindBwL'),
(18, 'Rohan', 'rohan921310@gmail.com', '123456', 0, '2021-04-13', '', 'u3QYYwcynA');
...
ALTER TABLE `payments_history`
  ADD PRIMARY KEY (`payments_history_id`);
...
--
ALTER TABLE `all_bids`
  MODIFY `all_bids_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `payments_history`
  MODIFY `payments_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
